  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      >
        ...
        {/*
          Sân thử nghiệm: có đường vào, nhưng không nằm trong menu.

          Nó không phải một tính năng của sản phẩm — nó là chỗ ép các mốc thời gian tới ngay để
          chứng minh nghiệp vụ, và một trong các nút ở đó dời ngày khởi hành của cả chuyến. Để nó
          đứng trong menu như mọi mục khác là mời người xem bấm thử một thứ họ tưởng là chức năng
          bán hàng.

          Nên nó nằm ở đây: chìm dưới đáy thanh bên, chữ nhỏ, màu mờ, không biểu tượng — trông như
          một nhãn phiên bản. Ai biết thì bấm, còn lại thì lướt qua. Đường dẫn /admin/sandbox vẫn
          gõ thẳng vào được.
        */}
        <Link
          to="/admin/sandbox"
          title="Công cụ nội bộ: ép các mốc thời gian để kiểm nghiệp vụ"
          className="mx-4 mb-1 block rounded px-2 py-1 text-[10px] tracking-wide text-slate-700 transition-colors hover:bg-slate-800/60 hover:text-slate-400"
        >
          nội bộ · kiểm nghiệp vụ
        </Link>
