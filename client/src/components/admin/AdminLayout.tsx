...
const navEntries: NavEntry[] = [
  ...
  {
    /*
     * Sân thử nghiệm đứng riêng và đứng cuối.
     *
     * Nó không phải một phần của việc vận hành hằng ngày — nó là chỗ ép các mốc thời gian tới ngay
     * để chứng minh nghiệp vụ. Xếp chung vào nhóm "Điều hành" thì có ngày ai đó bấm nhầm nút tua
     * ngày khởi hành khi đang tìm màn quản lý chuyến.
     */
    kind: "link",
    to: "/admin/sandbox",
    label: "Sân thử nghiệm",
    icon: icon(
