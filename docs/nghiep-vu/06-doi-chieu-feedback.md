...
hoạch. Cột cuối chỉ thẳng chỗ đặt luật để đối chiếu được ngay. Bộ kiểm thử: 496 bài, xanh.
...
| **496 kiểm thử tự động**, chạy trong quy trình tích hợp liên tục | Đã triển khai |
