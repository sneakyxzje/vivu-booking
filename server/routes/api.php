...
Route::get('/tours/{tourId}/reviews', [
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    ...
    Route::middleware('role:customer')->group(function () {
        ...
        // ROUTER CŨ GIỮ NGUYÊN
        Route::post('/tours/{id}/reviews', [
    ...
    */
    ...
    Route::middleware('role:guide')->prefix('guide')->group(function () {
        ...
        Route::get('/my-tours', [
            GuideTourController::class,
            'index'
        ]);



        Route::get('/my-tours/{id}', [
            GuideTourController::class,
            'show'
        ]);
        ...
        Route::get('/bookings', [
            GuideBookingController::class,
            'index'
        ]);



        Route::put('/bookings/{id}/confirm', [
            GuideBookingController::class,
            'confirm'
        ]);
    ...
    */
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::put('/tour-schedules/{id}/assign-guide', [
            AdminTourController::class,
            'assignScheduleGuide'
        ]);
